...
public class FormAdicionarPet extends AppCompatActivity {
  ...
  private EditText edit_nome_pet,
      edit_tipo_pet,
      edit_descricao_pet,
      edit_idade,
      edit_peso,
  ...
  public void verificaPermissaoGaleria(View view) {
    ...
    showDialogPermissaoGaleria(
        permissionListener, new String[] {Manifest.permission.READ_EXTERNAL_STORAGE});
  }
  ...
  private void showDialogPermissaoGaleria(PermissionListener listener, String[] permissoes) {
    TedPermission.create()
        ...
        .setDeniedMessage(
            "Você negou as permissões para acessar a galeria do disposivito, deseja permitir ?")
              ...
              if (!alturaPet.isEmpty()) {
                ...
                if (caminhoImagem != null) {
                  ...
                  if (pet.getUrlImagem() != null) {
                    ...
                    Toast.makeText(this, "Selecione uma imagem para o pet.", Toast.LENGTH_SHORT)
                        .show();
                  }
                }
          ...
          try {
            imagem =
                MediaStore.Images.Media.getBitmap(
                    getBaseContext().getContentResolver(), localImagemSelecionada);
          } catch (IOException e) {
            e.printStackTrace();
          }
        } else {
