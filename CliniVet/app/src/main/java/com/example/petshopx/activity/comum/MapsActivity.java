...
import com.example.petshopx.databinding.ActivityMapsBinding;
...
public class MapsActivity extends FragmentActivity implements OnMapReadyCallback {
  ...
  public void onMapReady(GoogleMap googleMap) {
    ...
    LatLng petShopLocalization = new LatLng(-4.9691314, -39.0246896);
    mMap.addMarker(new MarkerOptions().position(petShopLocalization).title("PetShop"));
    mMap.moveCamera(CameraUpdateFactory.newLatLng(petShopLocalization));
  }
}
