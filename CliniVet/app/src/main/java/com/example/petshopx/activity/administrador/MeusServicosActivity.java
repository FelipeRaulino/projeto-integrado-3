...
public class MeusServicosActivity extends AppCompatActivity implements AdapterServicos.OnClick {
  ...
  private void configCliques() {
    findViewById(R.id.ib_add)
        .setOnClickListener(view -> startActivity(new Intent(this, FormServicoActivity.class)));
  ...
  private void configRv() {
    ...
    rv_servicos.setListener(
        new SwipeLeftRightCallback.Listener() {
          @Override
  ...
  private void cancelarPossiveisReservas(String idServico) {
    DatabaseReference reference = FirebaseHelper.getDatabaseReference().child("reservas_all");
              ...
              for (DataSnapshot snap : snapshot.getChildren()) {
                ...
                if (reserva.getIdServico().equals(idServico)) {
                  if (reserva.getStatus().equals("pendente")
                      || reserva.getStatus().equals("reservada")) {
                    reserva.setStatus("cancelada");
                    reserva.cancelarReserva();

                    DatabaseReference reference2 =
                        FirebaseHelper.getDatabaseReference().child("reservas");
