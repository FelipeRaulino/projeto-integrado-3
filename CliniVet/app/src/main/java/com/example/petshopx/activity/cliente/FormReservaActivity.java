...
public class FormReservaActivity extends AppCompatActivity {
  ...
  protected void onCreate(Bundle savedInstanceState) {
    ...
    // config hora
    ArrayAdapter<String> adapterhora =
        new ArrayAdapter<String>(
            getApplicationContext(), android.R.layout.simple_spinner_dropdown_item, horarios);
  ...
  private void recuperaPets() {
    DatabaseReference reference =
        FirebaseHelper.getDatabaseReference().child("pets").child(FirebaseHelper.getIdFirebase());
    ...
    btn_reservar.setOnClickListener(
        view -> {
          if (spinner.getSelectedItem().toString().equals("Não há pets cadastrados")) {
            Toast.makeText(
                    this, "adicione um pet para prosseguir com a reserva", Toast.LENGTH_SHORT)
                .show();
          } else {
            confirmarReserva();
          }
  ...
  private void confirmarReserva() {
    ...
    DatabaseReference reference = FirebaseHelper.getDatabaseReference().child("usuarios");
        ...
        new ValueEventListener() {
          ...
          public void onDataChange(@NonNull DataSnapshot snapshot) {
            if (snapshot.exists()) {
              ...
              Toast.makeText(FormReservaActivity.this, "Reserva realizada", Toast.LENGTH_SHORT)
                  .show();
              finish();
            } else {
        ...
        new DatePickerDialog.OnDateSetListener() {
          ...
          public void onDateSet(DatePicker datePicker, int year, int month, int day) {
            ...
            if (year >= y) {
                ...
                if (month >= m) {
                  ...
                  if (month == m) {
                    if (day >= d) {
                      ...
                      Toast.makeText(
                              FormReservaActivity.this,
                              "Esse dia é anterior ao atual.",
                              Toast.LENGTH_SHORT)
                          .show();
                    }
                  }
              ...
              Toast.makeText(
                      FormReservaActivity.this, "Esse ano é anterior ao atual.", Toast.LENGTH_SHORT)
                  .show();
            }
          }
        };
