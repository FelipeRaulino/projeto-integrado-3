...
public class EditarStatusReservaActivity extends AppCompatActivity {
  ...
  protected void onCreate(Bundle savedInstanceState) {
    ...
    ArrayAdapter<String> adapterStatus =
        new ArrayAdapter<String>(
            getApplicationContext(), android.R.layout.simple_spinner_dropdown_item, statusOptions);
  ...
  private void configCliques() {
    ...
    reserva_spinner.setOnItemSelectedListener(
        new AdapterView.OnItemSelectedListener() {
          ...
          public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
            ...
            DatabaseReference reference2 =
                FirebaseHelper.getDatabaseReference().child("reservas_all").child(reserva.getId());
            reference2.setValue(reserva);

            Toast.makeText(
                    EditarStatusReservaActivity.this,
                    "O status da reserva foi atualizado para " + novoStatus,
                    Toast.LENGTH_SHORT)
                .show();
          }
  ...
  public void detalhesServico(View view) {
    DatabaseReference reference = FirebaseHelper.getDatabaseReference().child("servicos");
            ...
            if (snapshot.exists()) {
              for (DataSnapshot snap : snapshot.getChildren()) {
                ...
                if (servico.getId().equals(reserva.getIdServico())) {
                  Intent intent =
                      new Intent(EditarStatusReservaActivity.this, DetalhesServicoActivity.class);
