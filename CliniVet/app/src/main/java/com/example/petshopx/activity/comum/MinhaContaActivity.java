...
public class MinhaContaActivity extends AppCompatActivity {
  ...
  private void validaDados() {
    ...
    if (!nome.isEmpty()) {
      if (!telefone.isEmpty()) {
        ...
        usuario.salvar();
        atualizarReservas(nome, telefone);
        progressBar.setVisibility(View.GONE);
  ...
  private void atualizarReservas(String nome, String telefone) {
          ...
          public void onDataChange(@NonNull DataSnapshot snapshot) {
            if (snapshot.exists()) {
              ...
              for (DataSnapshot snap : snapshot.getChildren()) {
                ...
                if (reserva.getIdDono().equals(usuario.getId())) {
                  reserva.setDonoNome(nome);
                  reserva.setTelefoneDono(telefone);
                  reserva.salvar();
                }
              }
            }
